...
public class VolumeButton extends PauseButton{
	...
	private void loadImgs() {
		BufferedImage temp=LoadSave.loadSpriteAtlas(LoadSave.VOLUME_BUTTONS);
	...
	public void draw(Graphics g) {
		...
		g.drawImage(imgs[0],buttonX-VOLUME_WIDTH/2,y,VOLUME_WIDTH,height,null);
	}
